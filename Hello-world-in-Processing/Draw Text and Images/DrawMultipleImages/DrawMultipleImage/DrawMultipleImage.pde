...
//
pic1 = loadImage("pikachu_hi_pokemon.jpg"); //Dimension: 800 Width, 600 Height
//pic1 is origonally landscape
pic2 = loadImage("OpenEuphoria_mascot_200px.png"); //Dimension: 860 Width, 529 Height //bike.jpg is landscape presentation
//
rectXPic1 = width*1/4;
rectYPic1 = height*0;
...
rectWidthPic2 = width*1/6; //longer side in rectangle landscape presentation, from size()
rectHeightPic2 = height*1/4; //shorter side in rectangle landscape presentation, from size()
picImageWidthRatio2 = 200.0/200.0; //Image width is longer, thus 1;
picImageHeightRatio2 = 200.0/200.0; //Image height is shorter, thus <1 
picX2 = rectXPic2;
picY2 = rectYPic2;
